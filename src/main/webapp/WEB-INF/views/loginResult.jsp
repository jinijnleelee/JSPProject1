...
charset=UTF-8 : 현재 문서를 해석할 때 UTF-8인코딩을 이용해서 해석(해석 방법 안내)
...
자바코드의 값을 HTML 형식으로 출력(자바의 값을 화면에 보이게 함 )
 ...
 -> EL(Expression Langauge, 표현언어) 로 변경
...
<body>
	...
	//Object로 업캐스팅했기때문에 String으로 다운캐스팅 필요
	...
	<!-- history.back() == 여태 했던 모든 기록들이 남아있음. -->
